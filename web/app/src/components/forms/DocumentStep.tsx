...
const paymentTermGroups = [
  ...
  },
  {
    title: '2. การแบ่งงวด',
    terms: [
      { label: '1.มัดจำ 60% งวดที่ 1/2', value: 'มัดจำ 60% งวดที่ 1/2 ก่อนเริ่มงาน, ส่วนที่เหลือชำระเมื่อส่งมอบ' },
      { label: '2.มัดจำ 40% งวดที่ 2/2', value: 'มัดจำ 40% งวดที่ 2/2 ส่งมอบงาน' },
